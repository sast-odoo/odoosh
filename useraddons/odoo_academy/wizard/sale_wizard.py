...
class SaleWizard(models.TransientModel):
    ...
    def _default_session(self):
        #we want to return our current session, which is the active id in the context
    ...
    session_id = fields.Many2one(comodel_name="academy.session",
                                string="Session",
                                required=True,
                                default=_default_session) #default session is a function
